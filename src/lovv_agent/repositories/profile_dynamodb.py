"""DynamoDB repository for LovvUserProfile table (read-only).
...
class ProfileRepository:
    ...
    def get_profile(self, actor_id: str) -> ProfileRecord | None:
        ...
        try:
            ...
            # Profile is optional — graceful degradation to no-profile.
            return None
...
def _parse_profile_item(item: dict[str, Any]) -> ProfileRecord | None:
    """Parse a DynamoDB item into a ProfileRecord.
