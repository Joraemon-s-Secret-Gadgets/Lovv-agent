...
export class AgentCoreStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AgentCoreStackProps) {
    ...
    // Lovv runtime keeps S3 Vectors and DynamoDB as in-process repository
    // boundaries, so the AgentCore execution role needs direct read access.
    ...
    const profileTable = dynamodb.Table.fromTableName(this, 'LovvUserProfile', `${spec.name}-LovvUserProfile`);
