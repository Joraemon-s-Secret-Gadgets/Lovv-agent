...
def test_response_resume_weather_alternative_uses_mixed_after_indoor() -> None:
    result = response_resume_update(
        {
            "request": {
                "request_id": "REQ-WEATHER",
