# [이동됨] → V2_22_PROFILE_CONFIG.md

> 이 파일은 폐기. 번호 21은 축제 지시서(V2_21_FESTIVAL_DIRECTIVE)가 선점. Profile config는 **V2_22_PROFILE_CONFIG.md** 참조.

---

# (구) V2_21 — Profile theme-weight config (확정)
